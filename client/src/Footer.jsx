    ...
    <div className='py-[4rem] px-[15rem] 1lg:px-[3rem] z-10 sm:px-[2rem] 1sm:px-[1rem] bg-[#09090b] text-white font-raleway'>
      <div className="flex 1sm:flex-col 1sm:gap-[1rem] justify-between 1sm:justify-items-start 1sm-[4rem]"> 
        <div className="relative">
            ...
            <Link className="grid text-footer no-underline text-[0.8rem] font-[400] uppercase mb-[0.4rem] hover:text-white" to="/products">Products</Link>
            <Link className="grid text-footer no-underline text-[0.8rem] font-[400] uppercase mb-[0.4rem] hover:text-white" to="/services">Services</Link>
            <Link className="grid text-footer no-underline text-[0.8rem] font-[400] uppercase mb-[0.4rem] hover:text-white" to="">Cart</Link>
            <Link className="grid text-footer no-underline text-[0.8rem] font-[400] uppercase mb-[0.4rem] hover:text-white" to="">Contact us</Link>
            <Link className="grid text-footer no-underline text-[0.8rem] font-[400] uppercase mb-[0.4rem] hover:text-white" to="">Sell on urban trove</Link>
            <Link className="grid text-footer no-underline text-[0.8rem] font-[400] uppercase mb-[0.4rem] hover:text-white" to="">Checkout</Link>
            <Link className="grid text-footer no-underline text-[0.8rem] font-[400] uppercase mb-[0.4rem] hover:text-white" to="">Privacy policy</Link>
            <Link className="grid text-footer no-underline text-[0.8rem] font-[400] uppercase mb-[0.4rem] hover:text-white" to="">Report fraud</Link> 
        </div>
        <div className="relative">
