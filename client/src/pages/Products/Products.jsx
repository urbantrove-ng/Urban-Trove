...
export default function Products() {
  ...
  return (
    <>
      <MiniHeader />
      <MiniProductsHeader />
      <div className="my-[2rem] md:my-[0.5rem] mx-[1rem] sm:mx-[0.2rem] md:mx-[0.4rem] 1sm:mt-[12rem] sm:mt-[10.5rem] bg-[#e5e5e5] p-[2rem] sm:p-[0.9rem] md:p-[0.5rem] grid grid-cols-4 1sm:grid-cols-2 md:grid-cols-3 gap-[1rem] sm:gap-[0.6rem] justify-center font-sans">
        {productData.map((product) => {
          ...
          return (
            ...
            >
              ...
              <h4 className="mb-[0.5rem] font-[400] mt-[0.5rem] md:mt-0 h-[3.2rem] 1lg:line-clamp-2 sm:line-clamp-2 md:line-clamp-2 sm:overflow-hidden">
                {details}
              </h4>
              ...
              <div className="flex sm:flex-col justify-between sm:justify-items-start items-center sm:items-start ">
                <h2 className="font-[700] text-[1.4rem] 1lg:text-[1.2rem] sm:text-[1.1rem]">
                  &#8358;{formattedActualPrice}
                </h2>
                <h3 className="text-[1rem] sm:text-[0.8rem] md:text-[0.9rem] font-[700] text-[#737373]  line-through">
                  &#8358;{formattedDiscountedPrice}
                </h3>
                <h6 className="bg-[#bb8c56] 1lg:hidden md:block font-[700] text-[0.6rem] sm:text-[0.5rem] p-[0.1rem] sm:mb-[0.3rem] rounded-[5px] text-white">
                  {price.discount}
                </h6>
              </div>
              <hr />
